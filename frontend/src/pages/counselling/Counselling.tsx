...
const mockCounselors = [
  ...
  },
  {
    ...
    title: 'Career Coach',
    specializations: ['Business', 'Management', 'Leadership'],
    experience: '6 years',
    rating: 4.7,
    totalSessions: 189,
    availability: 'Available',
  ...
  },
  {
    ...
    specializations: ['Mental Health', 'Stress Management', 'Academic Support'],
    experience: '10 years',
    rating: 4.9,
    totalSessions: 312,
    availability: 'Available',
    bio: 'Licensed psychologist specializing in student mental health and academic stress.',
